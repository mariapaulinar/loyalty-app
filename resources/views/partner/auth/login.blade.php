        ...
        <div
            ...
            <div 
                x-data="partnerLoginFlow({
                    ...
                    canRegister: {{ ($registrationEnabled ?? false) ? 'true' : 'false' }}
                })"
                x-cloak
            ...
            >
                ...
                <div x-show="step === 'email'" x-transition:enter="transition ease-out duration-300"
                    ...
                    @if(config('default.app_demo'))
                        <div class="p-4 rounded-xl bg-accent-50 dark:bg-accent-900/20 border border-accent-100 dark:border-accent-800 cursor-pointer transition-colors hover:bg-accent-100 dark:hover:bg-accent-900/30 group mb-6"
                            @click="fillDemo()">
                    ...
                    <form @submit.prevent="checkEmail" class="space-y-6">
                        ...
                        <x-forms.button 
                            ...
                            button-class="w-full py-3.5 text-base font-bold text-white rounded-xl transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed" />
                    </form>
                ...
                <div x-show="step === 'auth'" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div x-show="!userHasPassword" class="space-y-6" x-cloak>
                        ...
                        <button 
                            ...
                            @click="sendOtp"
                            :disabled="loading"
                            class="w-full py-3.5 text-base font-bold text-white bg-primary-600 hover:bg-primary-500 rounded-xl transition-colors duration-200 disabled:opacity-50 flex items-center justify-center gap-2">
                            <x-ui.icon icon="mail" class="w-5 h-5" />
