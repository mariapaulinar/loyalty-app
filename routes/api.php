...
/*
|--------------------------------------------------------------------------
| Stripe Billing Webhooks (Server-to-Server)
|--------------------------------------------------------------------------
|
| Laravel Cashier webhook handler for Stripe subscription events.
| Only active when BILLING_PROVIDER=stripe in .env.
| Uses Cashier's signature verification internally.
|
*/
Route::post('stripe/webhook', [\App\Http\Controllers\Billing\StripeWebhookController::class, 'handleWebhook'])
