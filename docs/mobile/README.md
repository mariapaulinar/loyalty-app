...
Una herramienta de diseño debe leer 00, 02, 05, 06, 09, 10 y acceptance. Un generador de apps debe leer todos los documentos canónicos, contrastar routes/api.php y no inventar endpoints.
